...
def home():
    return '''
        ...
        <h3>Append the following path and your chosen location after the url to get 
        the current weather</h3>
        <ul>/api/v1.0/weather?location=<b>&#60;input location&#62;</b></ul>
        <h3>Append the following path and your chosen location after the url to get 
        the current temperature</h3>
        <ul>/api/v1.0/temperature?location=<b>&#60;input location&#62;</b></ul>
        <h3>Append the following path and your chosen location after the url to 
        get the current wind speed and direction</h3>
        <ul>/api/v1.0/wind?location=<b>&#60;input location&#62;</b></ul>
        <h3>Append the following path and your chosen location after the url to 
        get the current humidity</h3>
...
def weather():
    ...
    weather_list = ['rain', 'hurricanes', 'cloudy', 'partly cloudy', 'blizzard',
                    'tornado', 'thunderstorm', 'fog', 'lightning', 'snow',
                    'wind', 'hail', 'winter storm', 'stormy']
